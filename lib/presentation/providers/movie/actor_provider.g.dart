...
String _$actorHash() => r'391bbb5a3a1367831967655668aa26902bf5bdc6';
...
/// See also [actor].
class ActorFamily extends Family<AsyncValue<List<ActorModel>>> {
  /// See also [actor].
  const ActorFamily();
...
/// See also [actor].
class ActorProvider extends AutoDisposeFutureProvider<List<ActorModel>> {
  /// See also [actor].
  ActorProvider({
    required int movieId,
  }) : this._internal(
  ...
  Override overrideWith(
    FutureOr<List<ActorModel>> Function(ActorRef provider) create,
  ) {
  ...
  @override
  AutoDisposeFutureProviderElement<List<ActorModel>> createElement() {
...
mixin ActorRef on AutoDisposeFutureProviderRef<List<ActorModel>> {
  /// The parameter `movieId` of this provider.
  int get movieId;
}

class _ActorProviderElement
    extends AutoDisposeFutureProviderElement<List<ActorModel>> with ActorRef {
